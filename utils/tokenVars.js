const tokenVars = {
  // JSON-RPC Provider that connects to the blockchain.
  providerJsonRpc: "https://bsc-dataseed1.binance.org/",

  // PancakeSwap Router & Factory Addresses.
  pcsRouterAddress: "0x10ed43c718714eb63d5aa57b78b54704e256024e",
  pcsFactoryAddress: "0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73",

  // Base token addresses for Binance Smart Chain.
  // First token: BNB, Second token: BUSD, Third token: USDT
  baseTokens: [
  ...
  // ABIs to Interact with the Smart Contracts.
  tokenABI: [
    {
      inputs: [
    ...
    {
      inputs: [
        { internalType: "uint256", name: "swapNumber", type: "uint256" },
      ],
